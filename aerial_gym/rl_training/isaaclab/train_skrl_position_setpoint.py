"""
Train PositionSetpointEnv with skrl PPO.
...
parser = argparse.ArgumentParser(description="Train position setpoint with skrl PPO")
...
def main():
    ...
    cfg_path = os.path.join(
        os.path.dirname(__file__), "agents", "position_setpoint_skrl_ppo.yaml"
    )
